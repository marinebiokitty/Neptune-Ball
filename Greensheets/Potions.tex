...
Potions can be administered in two ways. A willing or helpless target can drink the potion, in which case, the person administering the potion should hand over the potion item envelope to the target. A conscious, but ignorant target can also be injected with a potion. To accomplish this, you must roll an 8, 9 or 10 on a D10 (gm provided) while within 1 ZoC of your target. If you don't roll an 8, 9 or 10, you can keep rolling until you do, or until someone stops you. If anyone asks you what you are doing, you must tell them that you look like you are trying to do something without the target's permission. If you succeed in your roll, give the potion to a GM to give to your target. \textbf{Some potions may require different thresholds. Check the relevant greensheet or ability carefully.}


\emph{There is no mechanic for leveling up in game.}

{\bf Each magician can only brew two potions at a time.} %%There will be 5 or 6 cauldrons (1 in banquet hall).
...
\begin{enumerate}
  \item Level 1
   \begin{enumerate}
     ...
     \item \aLesserDispel{} - Instant spell. Can completely remove a magical effect of level-2 or lower. Can be used on magical locks to reduce the target threshold by 1. Does not stack with other uses of \aGreaterDispel{} or \aLesserDispel{}. If you stop trying to get into the lock, the effect fades before you can start again. Can disrupt shape shifters momentarily.
   \end{enumerate}
  \item Level 2
   \begin{enumerate}
  ...
  \item Level 3
   ...
   \item Level 6
    \begin{enumerate}
      \item \aGreaterDispel{} - Instant spell. Can break spells up to level-4. Can be used on magical locks to reduce the target threshold by 3. Does not stack with other uses of \aGreaterDispel{} or \aLesserDispel{}. If you stop trying to get into the lock, the effect fades before you can start again. Can disrupt shape shifters temporarily.
    \end{enumerate}
   \item Level 7
    \begin{enumerate}
...
\item \iSnails{} is very poisonous, even on its own. %%Deadly poison
...
\item \iSquid{} is able to alter the consumer's body in dangerous ways.  %%shapeshifter
\end{enumerate}
