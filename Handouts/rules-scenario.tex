%%%%% ADD IN A SECTION ABOUT MASKS, AND HOW THIS IMPACTS COMMUNICATION (TO DO)
%%
...
real-space roleplaying game sponsored by the Luminary Roleplay Society.
...
not represent the opinions of the GMs or the Luminary Roleplay Society.
...
\cKing{\King} \cKing{} is delighted that you have agreed to attend the Neptune Ball. This annual bash is the most exclusive, and grandest ball in all of Atlantica to celebrate the turning of the year. There will be dancing, refreshments, and a grand banquet, with all of the finery the palace has to offer.
...
\emph{Unless you know otherwise, your character is free to leave gamespace by going up the main door to the room and declaring your intentions with a 15 count, but your character MAY NOT return if you choose to leave. {\bf Players} may step out at any time for self-care.}
...
\paragraph{Game Times:} Game runs from 8pm to 12am on {\bf Saturday, February 29th} in the Patriots Room. Surviving PCs are expected to be in-game for the entirety. {\bf Please be on time} as game runs 3.5 hours exactly and we need time to get set up together beforehand (i.e.: I need to give you hard copies of all of your game material).  Game may end early.  %Cleanup and Wrap-up will occur during the final hour. Please plan to arrive at {\bf 1:30 pm} sharp to get situated before the game starts, or {\bf 1:00 pm if you do not arrange to pick up your packet ahead of game}. {\bf If you will be late, you must CALL the GMs and let us know. Acata: 650-690-5628}; otherwise we reserve the right to give away your character to an observer.  %There will be an optional dance lesson from 1:00 pm to 1:30 pm to review a few basic dance forms.

%\paragraph{Game Spaces:} We will be playing in several suite rooms that open onto the courtyard, as well as most of the courtyard itself. The GMs will place you where you need to be for game start.
...
\paragraph{Electronic Copies:} You should have receieved electronic copies of your character sheet, and any bluesheets, green sheets, white sheets, and abilities your character has. Not all characters have all of these types of documents. Your character sheet will list them at the bottom.
...
%Shooting your friend outside of another suit one minute before another game
%lets out is a bad idea, as is screaming bloody murder (or ``Fire'') down a hallway.
...
\subsection{Potentially Triggery Topics}
As described in the game advertisement, and further detailed in the casting survey, this game deals with some very heavy topics. I have done my best to respect what folks shared with me, but there is always a possibility that I missed something, or that something unexpectedly activates you. We will employ {\bf cut and break}, which we will go over at game start to help you modify or exit situations that you need to.
...
doors, inside ceilings, or in other places where retrieval might be dangerous; consequently, don't go rummaging through such places for
game items.  Don't stash or search in places that are not in-game.%; see the {\em Game Areas} section for more information.
...
character packet, read their journal, steal their dinner, etc.  If the
...
your character's apparent age in decades. All bodies are 3 hands bulky.
...
There will be a ``banquet'' 1.5 hours into game. All guests are expected to attend. There won't be any actual food at the game. Please eat dinner before arriving to game. \cPrincess{\Prince} \cPrincess{} is organizing an event to precede the banquet.
