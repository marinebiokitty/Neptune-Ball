...
If your character is showing up to the Neptune's Ball with another character, you may freely discuss with that player how you'd like to play the relationship that your characters {\bf start game} having; there are no spoilers in that information.  Please {\bf do not} discuss any ways you think that relationship might change over the course of game.

In order to preserve the intended experience for you and your fellow players, we {\bf require} that you check with the GMs before you contact a fellow player for any pre game calibration besides the case described above.  We will help make sure that the other player is willing to discuss the issue and that you are not unintentionally sharing things you didn't realize were spoilers.
