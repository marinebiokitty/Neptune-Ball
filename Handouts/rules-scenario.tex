...
\subsection{Pre-Game Calibration and Character Secrets:} Some players may find pre-game calibration supportive, while others do not and would prefer to avoid it. Please be respectful of your fellow players' preferences and ask before engaging in any pre-game calibration. Such calibration is also made more complicated by a game rife with character secrets that are meant to be discovered during game play. We encourage you to ``play to discover'' as much as possible. Still, you may find it useful to touch base with \textbf{amicable} family members and \textbf{established} romantic interests. We strongly encourage you to check in as you go during game to calibrate levels of intensity and animosity.
...
Any two adult characters are interfertile, e.g. a character may be a child of a male adult human and a male adult merperson.  
