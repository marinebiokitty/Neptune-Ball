...
\NEW{MemFold}{\mQPacketManta}{
  \s\MYname	{Open if you see a purple headband}
  \s\MYtext	{Drat, \cQueen{\they} \cQueen{\have} revealed \cQueen{\themself}. This will make it much harder to get rid of \cQueen{\them}...}
 }
...
\NEW{MemFold}{\mQPacketGladius}{
  \s\MYname	{Open if you see a purple headband}
  \s\MYtext	{Oh shit. \cQueen{} has revealed \cQueen{\themself} as \cAthena{} - you were afraid this was going to happen. \cKing{} is going to be pissed, and you may very well lose \cQueen{\them}...}
 }
