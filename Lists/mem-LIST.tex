...
\NEW{MemPage}{\mSpyFive}{
  \s\MYname	{How loyal are Atlantican citizens to the King? (Ask Osiris)}
...
\NEW{MemFold}{\mLovePacket}{
  ...
  \s\MYtext	{The spell is broken. Your free will is restored and all compulsion is gone. Lose the goal: ``Find some way to remain with Pearl once the ball concludes.''. Destroy the item card ``\iLoveSpell{}''.}
}
