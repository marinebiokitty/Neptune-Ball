...
\NEW{Place}{\pDungeons}{
  \s\MYname	{Dungeons 002}
	\s\MYsigns	{\sBarnacles{} \sDungeons{} \sCells{} \sGlowingBrick{}}%\sPacketD{}
  \s\MYitems	{}
}
 
\NEW{Place}{\pEntryWay}{
  \s\MYname	{Stairwell}
	\s\MYsigns	{\sOldMan{} \sOldManStory{} \sDotTwo{} \sGlowingBrick{} \sFamily{} \sForgery{} \sBustOne{} \sBustTwo{} \sBustThree{} \sBustFour{}} %\sApothecaryCover{} \sApothecaryOne{} \sApothecaryTwo{}\sBackgroundCheck{} \sBackgroundCheckTwo{}
  \s\MYitems	{}
}
  
\NEW{Place}{\pBanquet}{
  \s\MYname	{Banquet Hall 013}
	\s\MYsigns	{\sBanquetHall{} \sBanquetHall{} \sStage{} \sGlowingBrick{} \sPainting{} \sPainting{} \sPainting{} \sWestStoneQuestion{} \sWestStoneHidden{} \sRevealed{}}
  \s\MYitems	{}
}

\NEW{Place}{\pExplorerGuild}{
  \s\MYname	{Explorer's Guild 015}
...
\NEW{Place}{\pCaves}{
  \s\MYname	{Caves 015}
	\s\MYsigns	{\sCaves{} \sClamBed{} \sPearlStorage{} \sCrest{} \sRunicCircle{} \sGlowingBrick{}}%\sPacketB{} 
  \s\MYitems	{\multi{2}{\iSnails{}} \multi{6}{\iSeaUrchins{}}}
} 
  
\NEW{Place}{\pResidentialWing}{
  \s\MYname	{Residential Wing 030}
	\s\MYsigns	{\sResidences{} \sResidences{} \sKing{} \sKingPapers{} \sGeneral{} \sGeneralPapers{} \sMorvyn{} \sMorvynPapers{} \sPriest{} \sPriestPapers{} \sPrincess{} \sPrincessPapers{} \sAriel{} \sArielPapers{} \sManta{} \sMantaPaper{} \sPlant{} \sPlantPapers{} \sGlowingBrick{}}%\sPacketC{}
  \s\MYitems	{}
}
...
\NEW{Place}{\pPacificanSuite}{ %%Big room farthest away.  Actually pacifican embassy.
  \s\MYname	{Pacifican Suite 034}
  \s\MYsigns	{\sEmbassy{} \sEmbassy{} \sDiplomat{} \sDiplomatPapers{} \sPrince{} \sPrincePapers{} \sSpy{} \sSpyPapers{} \sPacketA{} \sDesk{} \sGlowingBrick{}}
  \s\MYitems  {}
}

\NEW{Place}{\pKitchen}{
  \s\MYname	{Kitchen 004}
	\s\MYsigns	{\sKitchen{} \sSeaSnake{} \sSwordfishMeat{}\sDotThree{} \sGlowingBrick{} \multi{5}{\sEmptyCauldron{} \sFullCauldron{}} \sDoNotTouchPotions{}}
  \s\MYitems	{}
}
 
\NEW{Place}{\pGM}{
  \s\MYname {Owned by GMs}
  \s\MYgreens{\gDanceScoring{} \gChecklist{} \gWishingStone{} \gBackgroundGM{} \multi{5}{\gNPC{}}}
  \s\MYitems  {\iScroll{} \iBaby{}}
	\s\MYabils  {\aBlades{} \aCloak{} \aSight{} \aProtection{} \aProtection{} \aProtection{} \aClarity{} \aDexterity{} \aTruth{} \aTruth{} \aTruth{} \aTruth{} \aTemperance{} \aTemperance{} \aJoy{} \aRevealed{} \aRevealed{} \multi{5}{\aXStep{}\aMerengue{}\aSwing{}}}
...
\NEW{Place}{\pAntiLycanthropyHerbs}{
  \s\MYname {the North Sea}
} 
